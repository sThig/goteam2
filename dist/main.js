...
function myClickFunc(e) {
  if (document.getElementById("bind").value == "") {
    ...
    var _deployVariables = deployVariables();

    var _deployVariables2 = _slicedToArray(_deployVariables, 5);

    deleteButton = _deployVariables2[0];
    editButton = _deployVariables2[1];
    currentValue = _deployVariables2[2];
    switchEdit = _deployVariables2[3];
    t = _deployVariables2[4];
    ...
    var toggleEdit = document.querySelector('#editName');
...
// Add edit button
function addEdit() {
  var editthis = document.createElement('span');
...
function generateMiddleNickname() {
  var adjective = ["Angry", "Spunky", "Meaty", "Meat", "Crabby", "Small", "Poop", "Pony", "baby", "Chocolate", "Fat", "Fun", "Wobble", "Jiggle", "Greedy", "Naked", "Zippy", "Home", "Flabby", "Drunken", "Snuggle", "Thunder", "Thigh", "Twisted", "Loose", "Fuzzy", "Stanky", "Double", "Leggy", "Fried", "Triple", "Tenacious"];
  var noun = ["Donkey", "Patties", "Monkey", "Crab", "Dawg", "Cat", "Whoppers", "Cow", "Pony", "Poop", "Whale", "Muscles", "Ankles", "Bubbles", "Hammer", "Chick", "Leg", "Wheels", "Pants", "Nylon", "Lube", "Timbers", "Thighs", "Fuzz", "Chin", "Belly"];
...
var formreset = document.getElementById('result');
var el = document.getElementById('bind');
var gobutton = document.getElementById('thego');
var nameOfPlayer = el.value;
...
document.getElementById("go").addEventListener("click", function () {
  if (document.getElementById('load').getElementsByTagName('li').length <= 2) {
    ...
    setTimeout(function () {
      var inputs = document.querySelectorAll(".player");
      var listItems = Array.from(inputs).map(function (input) {
        return input.innerHTML;
      });
      shuffle(listItems);

      var _listItems = _toArray(listItems),
          captain = _listItems[0],
          id = _listItems[1],
          teammates = _listItems.slice(2);

      var elem = document.getElementById("pre");
      var d = document.getElementById("result");
      d.className += "see";
      var namedteam = generateName();
      elem.className = 'hide';
      ...
      var span = document.querySelectorAll('#goAway, #edit');
