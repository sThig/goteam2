...
function editSwitcher() {
  ...
  textname.setAttribute("class", "editli")
  return textname;
}
  ...
  document.getElementById("go").addEventListener("click", function() {
    if (document.getElementById('load').getElementsByTagName('li').length <= 2)
    ...
    else
     {
      ...
      document.getElementById('captain').innerHTML += (`<p class="congrats">Congrats! You're Team <b style="color: black;">${namedteam}</b></p>`);
      document.getElementById('teamInfo').innerHTML += (`<p class="captain-subtext">Your captain is</p><h1 class="thecaptain">${captain}</h1>`);
      document.getElementById('coInfo').innerHTML += (`<p class="captain-subtext">Your co-captain is</p><h1 class="thecaptain">${id}</h1>`);
      document.getElementById('triInfo').innerHTML += (`<p class="captain-subtext">Team ${namedteam} members are</p>`);
